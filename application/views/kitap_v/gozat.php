        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="img-content">
              <img class="img-responsive" src="<?php echo base_url("assets/") ?>img/case-study-img1.png" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="case-study-content">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="img-content">
              <img class="img-responsive" src="<?php echo base_url("assets/") ?>img/case-study-img2.png" alt="">
            </div>
          </div>
          <div class="col-md-6">
            <!-- inner sub-title -->
